...
namespace BloomersWorkersManager.Domain.Extensions
{
    public static class ServicesExtensions
    {
        public static HostApplicationBuilder AddServices(this HostApplicationBuilder builder)
        {
            ...
            builder.Services.AddScopedAuthorizeNFeServices();
            builder.Services.AddScopedChangingOrderServices();
            builder.Services.AddScopedChangingPasswordServices();
            builder.Services.AddScopedInsertReverseServices();

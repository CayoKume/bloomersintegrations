...
{
    public class LinxProdutosDetalhesRepository<T1> : ILinxProdutosDetalhesRepository<T1> where T1 : LinxProdutosDetalhes, new()
    {
        ...
        public void BulkInsertIntoTableRaw(List<T1> registros, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - BulkInsertIntoTableRaw - Erro ao realizar BULK INSERT na tabela {tableName} - {ex.Message}");
            }
        }
        ...
        public async Task CallDbProcMerge(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - CallDbProcMerge - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public void CallDbProcMergeSync(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - CallDbProcMergeSync - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public async Task<string> GetParameters(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - GetParameters - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public string GetParametersSync(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - GetParametersSync - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task InsereRegistroIndividual(T1 registro, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - InsereRegistroIndividual - Erro ao inserir registro na tabela {tableName}, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public void InsereRegistroIndividualSync(T1 registro, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - InsereRegistroIndividualSync - Erro ao inserir registro na tabela {tableName}, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task<IEnumerable<Empresa>> GetEmpresas()
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - GetEmpresas - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public IEnumerable<Empresa> GetEmpresasSync()
        {
            ...
            {
                throw new Exception($"LinxProdutosDetalhes - GetEmpresasSync - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task<List<T1>> GetRegistersExists(List<T1> registros, string? tableName, string? db)
        {
            ...
            string query = $"SELECT cnpj_emp, cod_produto, timestamp FROM {db}.[dbo].{tableName} WHERE cod_produto IN ({identificadores})";

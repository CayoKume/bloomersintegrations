...
{
    public class LinxProdutosPromocoesRepository<T1> : ILinxProdutosPromocoesRepository<T1> where T1 : LinxProdutosPromocoes, new()
    {
        ...
        public void BulkInsertIntoTableRaw(List<T1> registros, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - BulkInsertIntoTableRaw - Erro ao realizar BULK INSERT na tabela {tableName} - {ex.Message}");
            }
        }
        ...
        public async Task CallDbProcMerge(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - CallDbProcMerge - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public void CallDbProcMergeSync(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - CallDbProcMergeSync - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public async Task<string> GetParameters(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - GetParameters - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public string GetParametersSync(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - GetParametersSync - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task<IEnumerable<Empresa>> GetEmpresas()
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - GetEmpresas - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public IEnumerable<Empresa> GetEmpresasSync()
        {
            ...
            {
                throw new Exception($"LinxProdutosPromocoes - GetEmpresasSync - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }

...
{
    public class LinxProdutosTabelasPrecosRepository<T1> : ILinxProdutosTabelasPrecosRepository<T1> where T1 : LinxProdutosTabelasPrecos, new()
    {
        ...
        public void BulkInsertIntoTableRaw(List<T1> registros, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - BulkInsertIntoTableRaw - Erro ao realizar BULK INSERT na tabela {tableName} - {ex.Message}");
            }
        }
        ...
        public async Task CallDbProcMerge(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - CallDbProcMerge - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public void CallDbProcMergeSync(string? procName, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - CallDbProcMergeSync - Erro ao realizar merge na tabela {tableName}, através da proc : {procName} - {ex.Message}");
            }
        }
        ...
        public async Task<string> GetParameters(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetParameters - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public string GetParametersSync(string tableName, string parameterCol)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetParametersSync - Erro ao obter parametros dos filtros da tabela LinxAPIParam, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task InsereRegistroIndividual(T1 registro, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - InsereRegistroIndividual - Erro ao inserir registro na tabela {tableName}, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public void InsereRegistroIndividualSync(T1 registro, string? tableName, string? db)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - InsereRegistroIndividualSync - Erro ao inserir registro na tabela {tableName}, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public async Task<IEnumerable<Empresa>> GetEmpresas()
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetEmpresas - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public IEnumerable<Empresa> GetEmpresasSync()
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetEmpresasSync - Erro ao obter as empresas da tabela LinxLojas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }

        public async Task<IEnumerable<String>> GetIdTabelaPreco(string cnpj)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetIdTabelaPreco - Erro ao obter codigos das tabelas de produtos da tabela LinxProdutosTabelas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }
        ...
        public IEnumerable<string> GetIdTabelaPrecoSync(string cnpj)
        {
            ...
            {
                throw new Exception($"LinxProdutosTabelasPrecos - GetIdTabelaPrecoSync - Erro ao obter codigos das tabelas de produtos da tabela LinxProdutosTabelas_trusted, atraves do sql: {sql} - {ex.Message}");
            }
        }

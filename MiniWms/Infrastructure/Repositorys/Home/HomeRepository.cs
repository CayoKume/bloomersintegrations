...
namespace BloomersMiniWmsIntegrations.Infrastructure.Repositorys
{
    public class HomeRepository : IHomeRepository
    {
        ...
        {
            var sql = $@"SELECT DOCUMENTO AS NUMBER FROM GENERAL..IT4_WMS_DOCUMENTO (NOLOCK) WHERE NB_TRANSPORTADORA = 65281 AND NB_DOC_REMETENTE = {doc_company} AND CHAVE_NFE IS NULL";
